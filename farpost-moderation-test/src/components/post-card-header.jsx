function postCardHeader(post) {
    function createLink () {
        let link = 'http://some-fake-link/' + post.postId;
        let anotherLink = 'http://another-fake-link/' + post.ownerId;
        return {link, anotherLink}
    }
    return (
        <div className="postCardHeader">
            <p>
                <a href={createLink().link} target="_blank">
                    {post.postId + ' '}
                </a> - {post.postDate}
            </p>
            <span>
                        ...
                        <a href={createLink().anotherLink} target="_blank">
                            {post.ownerName}
                        </a>
                    </span>
        </div>
